...
<script>
    ...
    // Initialize Firebase
    var config = {
        apiKey: "<?php echo e(config('services.firebase.apiKey')); ?>",
        authDomain: "<?php echo e(config('services.firebase.authDomain')); ?>",
        projectId: "<?php echo e(config('services.firebase.projectId')); ?>",
        storageBucket: "<?php echo e(config('services.firebase.storageBucket')); ?>",
        messagingSenderId: "<?php echo e(config('services.firebase.messagingSenderId')); ?>",
        appId: "<?php echo e(config('services.firebase.appId')); ?>",
        measurementId: "<?php echo e(config('services.firebase.measurementId')); ?>",
        databaseURL: "<?php echo e(config('services.firebase.databaseURL')); ?>"
    };
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cps\resources\views/scaninventory.blade.php ENDPATH**/ ?>