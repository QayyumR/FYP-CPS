    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark flex-md-column flex-row align-items-start py-3">
        <div class="collapse navbar-collapse ">
            <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between">
                ...
                <li class="nav-item">
                    <a class="nav-link pl-0" href="<?php echo e(route('logout')); ?>"><i class="fa fa-sign-out-alt fa-fw"></i> <span class="d-none d-md-inline">Logout</span></a>
                </li>
            </ul>
        </div>
    </nav>
</aside>
<?php /**PATH C:\xampp\htdocs\cps\resources\views/sidebar/dashboard.blade.php ENDPATH**/ ?>