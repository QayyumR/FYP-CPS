...
<div style="padding-top:30px;" class="container">
    <div class="row justify-content-center">
        <div class="container">
            <div class="card">
                <div class="card-header"><?php echo e(__('Inventory')); ?></div>
                <div class="card-body">
                    <table id="example" class="table table-hover table-sm nowrap" style="width:100%">
                        ...
                        <tbody style='text-align: center'>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-outline-info btn-sm" style="width:2rem; height:2rem; padding-right:0.2rem;" href="<?php echo e(route('viewitem', $item->id)); ?>" ><i class="fa fa-info"></i></a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cps\resources\views/inventory.blade.php ENDPATH**/ ?>